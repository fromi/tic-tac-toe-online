...
var tictactoeApp = angular.module('tictactoeApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'tictactoeAppUtils', 'pascalprecht.translate', 'truncate']);
